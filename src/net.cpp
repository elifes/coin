...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "eLifescoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"elifescoin.site", "192.168.100.138"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"localhost", "192.168.100.138"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. eLifescoin is probably already running."), addrBind.ToString().c_str());
        else
